...
export default function TableRow({ users, onModals }) {

    return users.map((el) => <tr key={el._id}>
        <td>
            <img
                src={el.imageUrl}
                alt={`${el.firstName}'s profile`}
                className="image"
            />
        </td>
        <td>{el.firstName}</td>
        ...
        <td className="actions">
            ...
            <button onClick={() => onModals('delete', el._id)} className="btn delete-btn" title="Delete">
                <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
            ...
            <button onClick={() => onModals('info', el._id)} className="btn info-btn" title="Info">
                <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
