(function (global, factory) {
  ...
  async function parseRequest(req) {
    ...
    const query = queryString
      ...
      .map((x) => x.split('='))
      .reduce(
        (p, [k, v]) => Object.assign(p, { [k]: decodeURIComponent(v.replace(/\+/g, ' ')) }),
        {}
      );
  ...
  var admin = (method, tokens, query, body) => {
    ...
    if (resource && resource.split('.').pop() == 'js') {
      ...
      files[resource] =
        files[resource] || fs__default['default'].readFileSync('./client/' + resource, 'utf-8');
    ...
    return function decorateContext(context, request) {
      ...
      function register(body) {
        if (
          ...
          context.protectedStorage.query('users', { [identity]: body[identity] }).length !== 0
        ) {
  ...
  var seedData = {
    recipes: {
      '3927279d-0ad4-4afb-8ca9-5b256ae3b298': {
        ...
        name: 'Bean Soup',
        img: 'https://vegancocotte.com/wp-content/uploads/2021/10/Easy-Three-Bean-Soup-0.jpg',
        ingredients: [
          '1 tbsp Ingredient 1',
          '2 cups Ingredient 2',
          '500 g  Ingredient 3',
      ...
      '8f414b4f-ab39-4d36-bedb-2ad69da9c830': {
        ...
        img: 'https://www.allrecipes.com/thmb/9O2dUMO-0XTKYFsI-4tQXEKdyhQ=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/114442-Grilled-Wild-Duck-Breast-DDMFS-4x3-11594-a102e9b82fd84d29b1d0e58b4831fbcf.jpg',
      ...
      '985d9eab-ad2e-4622-a5c8-116261fb1fd2': {
        ...
        name: 'Roast Trout',
        img: 'https://www.allrecipes.com/thmb/mcwYGQb-8APMrjcsOFOhSV8ouDo=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/236814-baked-fresh-rainbow-trout-DDMFS-4x3-5937dc3aadd74f25a85ef131cfed480f.jpg',
        ingredients: [
          '4 cups Ingredient 1',
          '1 tbsp Ingredient 2',
          '1 tbsp Ingredient 3',
